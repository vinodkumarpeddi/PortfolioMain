        ...
        {cards.map((c, i) => {
          ...
          return (
            <motion.button
              ...
              className={cn(
                "absolute left-1/2 top-4 h-[26rem] w-[19rem] -translate-x-1/2 cursor-pointer rounded-[26px] border bg-[#101013]/95 p-6 text-left [box-shadow:0_1px_0_rgba(255,255,255,0.06)_inset,0_40px_90px_-30px_rgba(0,0,0,0.9)] outline-none transition-[border-color] duration-[var(--duration-slow)] focus-visible:ring-2 focus-visible:ring-accent",
