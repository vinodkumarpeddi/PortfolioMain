import { AppShell, themes, NavItem, Pill } from "./ui";
    ...
    <AppShell
      ...
      aside={
        <>
          ...
          <div className="mt-3 rounded-xl border border-line-1 bg-bg-2 p-3">
    ...
    >
      <div className="grid grid-cols-[1.4fr_1fr] gap-4">
        <div className="rounded-2xl border border-line-1 bg-bg-2 p-5">
          ...
          <div className="mt-5 rounded-xl border border-line-1 bg-[var(--s-panel)] p-4">
        ...
        <div className="flex flex-col gap-4">
          <div className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-line-1 bg-[#140c26]">
            <div className="absolute inset-0 bg-[radial-gradient(60%_60%_at_50%_45%,rgba(192,38,211,0.28),transparent_70%)]" />
            <div className="absolute left-1/2 top-[38%] h-16 w-16 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/20 bg-white/10" />
            <div className="absolute left-1/2 top-[74%] h-16 w-28 -translate-x-1/2 -translate-y-1/2 rounded-t-[40px] border border-white/20 bg-white/10" />
            <div className="absolute left-3 top-3 flex items-center gap-1.5 rounded-full bg-black/50 px-2 py-1 font-mono text-[9.5px] text-white"><span className="h-1.5 w-1.5 rounded-full bg-[#f43f5e]" /> REC</div>
            <div className="absolute bottom-3 right-3 flex gap-1.5">
              <span className="rounded-md border border-white/20 bg-black/50 px-2 py-1 font-mono text-[9.5px] text-white">cam on</span>
              <span className="rounded-md border border-white/20 bg-black/50 px-2 py-1 font-mono text-[9.5px] text-white">mic on</span>
            </div>
          </div>
